...
/**
 * toggle search in mobile devises
 */
...

{
 ...
 if(!searchField.value){
    ...
    searchResult.classList.innerHTML ="";
...
const errorContent = document.querySelector("[data-content-error]");
/**
 * render all weather data in html page
 * @param {number} lan latitude
...
fetchData(url.forecast(lat, lon ), function(forecast){
    ...
    <h class="title-2" id="forecast-label">5 Days Forecast</h>
